      ...
      >
        ...
        >
          ...
          <p style={{ textAlign: "justify", maxWidth: "700px" }}>
            At Flight Finder, we believe that air travel and sustainability can
            go hand in hand. As a flight price aggregator, we are committed to
          ...
          <p style={{ textAlign: "justify", maxWidth: "700px" }}>
            ...
            platform helps travelers make informed choices by highlighting
            flights with lower emissions and promoting airlines that actively
          ...
          <p style={{ textAlign: "justify", maxWidth: "700px" }}>
            ...
            options for eco-friendly accommodations. We aim to make it easier
            for our users to reduce their environmental impact while still
            enjoying the convenience of air travel.
          </p>
